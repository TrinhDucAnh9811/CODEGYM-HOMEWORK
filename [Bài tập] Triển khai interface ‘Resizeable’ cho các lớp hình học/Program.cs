...
class Program
{
        ...
        {
            //Test Class Circle:
            Circle circle = new Circle(0.3d);
            Console.WriteLine($"The Radius of circle is: {circle.GetRadius()} ");

            circle.Resize(10.0d / 3.0d);
            Console.WriteLine($"The Radius of circle is: {circle.GetRadius()} ");

            //Test class Retangle:
            Regtangle reg = new Regtangle(2,2);
            Console.WriteLine($"The Perimeter of regtangle is: {reg.GetPerimeter()} ");
            Console.WriteLine($"The Area of regtangle is: {reg.GetArea()} ");
            Console.ReadKey();
